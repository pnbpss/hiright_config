...
echo DBALIAS=TAXOLD>> "C:\Program Files\SQLLIB\db2cli.ini"
...
echo PWD=InCome2K>> "C:\SQLLIB\db2cli.ini"
echo UID=HIRIGHT>> "C:\SQLLIB\db2cli.ini"
echo DBALIAS=TAXOLD>> "C:\SQLLIB\db2cli.ini"
